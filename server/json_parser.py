            ...
            with open(file_path, 'r') as file:
                ...
                for task in data["tasks"]:
                    ...
                    if command_type == "ping":
                        ...
                        transport_protocol = TransportProtocol.TCP if command_data["transport"] == "tcp" else TransportProtocol.UDP
                    ...
                    message_task = MessageTask(task_id=task["task_id"], frequency=task["frequency"], command=command)
